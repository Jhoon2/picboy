...
const Canvas = () => {
  ...
  const draw = (e) => {
    ...
    const Y = Math.floor(
      e.clientY - canvasRef.current.offsetTop + window.scrollY
    );
    if (isPainting === true) {
      if (rectState === true) {
          ...
          <LineStyle>
            <RangeWrap>
              <img
                src={stroke}
                alt="stroke"
                style={{ width: '24px', margin: '10px 0 10px 8px' }}
              />
              <LineWeightCustomWrap>
                <LineWeight
                  src={line6}
                  id="3"
                  onClick={lineWeightHandler}
                  style={
                    LineWeightCount === '3' ? { filter: 'brightness(0%)' } : {}
                  }
                  alt=""
                />
                <LineWeight
                  ...
                  onClick={lineWeightHandler}
                  style={
                    LineWeightCount === '8' ? { filter: 'brightness(0%)' } : {}
                  }
                  alt=""
                />
                <LineWeight
                  ...
                  onClick={lineWeightHandler}
                  style={
                    LineWeightCount === '14' ? { filter: 'brightness(0%)' } : {}
                  }
                  alt=""
                />
                <LineWeight
                  ...
                  onClick={lineWeightHandler}
                  style={
                    LineWeightCount === '20' ? { filter: 'brightness(0%)' } : {}
                  }
                  alt=""
                />
              </LineWeightCustomWrap>
