...
const UserProfile = () => {
  ...
  const editNickChange = (e) => {
    if (e.target.value.length >= 2 && e.target.value.length <= 8) {
      ...
      setEditNickValue('2글자 이상 8글자 이하로 입력해주세요');
    }
  };
  ...
  return (
    <UserProfileContainer>
      <ContainerInner>
            ...
            <TextProfileContents>
              ...
              <TextContentContainer>
                ...
                <Texts>
                  {editMyNickname ? (
                    <EditInput
                      placeholder={UserPage && UserPage.nickname}
                      onChange={editNickChange}
        ...
        {/* 카테고리별 */}
        <CategoryOpen
          value={UserPage && UserPage.username === userinfo.data.data.username}
        />
        ...
        <>
          ...
          <div
            style={{ width: '100px', height: '20px', backgroundColor: 'gray' }}
            ref={page === 0 ? null : lastIntersectingData}
          >
            .
          </div>
        </>
      ...
      {UserPage && UserPage.username === userinfo.data.data.username ? (
        <ProfileImageModal
          shown={myContext.isOpenProfileImg}
          close={() => {
