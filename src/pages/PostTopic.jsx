                ...
                <ContetnsWrap>
                    ...
                    <ModeWrap>
                        ...
                        <ModeFrameWrap>
                            ...
                            <ModeFrameBtnWrap>
                                <RandomTopicInput onChange={topicInput} value={topicInputState || topicState} type="text" placeholder='12자 제한입니다' maxLength={12} />
                                <ModeFrameBtn onClick={randomTopic}>랜덤선택</ModeFrameBtn>
                            </ModeFrameBtnWrap>
                            <ModeFrameTitle style={{ marginTop: '32px' }}>프레임</ModeFrameTitle>
                            <ModeFrameBtnWrap>
